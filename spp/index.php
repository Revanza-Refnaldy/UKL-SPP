          ...
          <div class="mm-par-wrap">
            <div class="mm-parallax" data-tilt data-tilt-max="4" >
              ...
              if($_SESSION['level'] == "admin"){
                echo "<div class=\"bg\" data-bg=\"https://wallpapercave.com/wp/wp4334648.jpg\" style=\"background-image: url(https://wallpapercave.com/wp/wp4334648.jpg);\">";
                echo "</div>";
              }elseif($_SESSION['level'] == "petugas"){
                echo "<div class=\"bg\" data-bg=\"https://wallpapercave.com/wp/wp4334648.jpg\" style=\"background-image: url(https://wallpapercave.com/wp/wp4334648.jpg);\">";
                echo "</div>";
              }else{
                echo "<div class=\"bg\" data-bg=\"/Assets/index_lofi.jpeg\" style=\"background-image: url(/Assets/index_lofi.jpeg);\">";
                echo "</div>";
              }
              ?>
